<template>
  <div class="sys-notices custom-block" style="width: 100%">
    <h3 class="custom-block-title">{{ t('dashboard.groupNotice') }}</h3>
    <ul>
      <li
          v-for="notification in notificationStore.groupNotification.slice(0, 5)"
...
import {getGroupNotification} from '@/services';
